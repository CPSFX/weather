...
import static com.cp.weather.util.Utility.handleSearchCityResponse;

import com.bumptech.glide.Glide;
import com.cp.weather.db.ConcernedCity;
import com.cp.weather.gson.MyForecast;
import com.cp.weather.gson.Weather;
import com.cp.weather.service.AutoUpdateService;
import com.cp.weather.util.DataSourceParse;
import com.cp.weather.util.HttpUtil;
import com.cp.weather.util.Utility;
...
import static com.cp.weather.util.Utility.handleProvinceResponse;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //配置服务器和个人信息
        HeConfig.init("HE2011261403441525","5327502e76754493971f2b5a5941eb97");
    ...
    private void showWeatherInfo(Weather weather) {
        ...
        String Time = weather.basic.updateTime.split(" ")[1];
