...
public class Weather {
    ...
    public com.cp.weather.gson.MyLifeStyle getMyLifeStyle() {
        return MyLifeStyle;
    }

    public void setMyLifeStyle(com.cp.weather.gson.MyLifeStyle myLifeStyle) {
